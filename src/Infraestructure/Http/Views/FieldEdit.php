            ...
            <form action="/field-edit/{<?= $data['id']; ?>}" method="POST">
                <div class="content div-2">
                    <div class="form-input">
                        ...
                        <input type="text" name="identificacao" id="identificacao" value="<?= $data['nameField'] ?>" class="input" placeholder="Exemplo 01" required>
                    </div>
                    <div class="form-input">
                        <label for="descricao" class="banap-label">Descrição</label>
                        <textarea name="descricao" id="descricao" cols="30" rows="10" class="textarea" placeholder="Descreva seu talhão..."><?= $data['descriptionField'] ?></textarea>
                    </div>
                    <div class="form-input">
